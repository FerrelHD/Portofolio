...
const Contact = () => {
  ...
  return (
    <motion.section 
      ...
      className="py-24 bg-dark text-white overflow-hidden"
    >
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 xl:gap-20 items-center">
          <div className="z-10 lg:pr-8">
            <motion.h2 variants={fadeUp} className="text-4xl sm:text-5xl lg:text-6xl font-black mb-8 leading-[0.9] tracking-tighter uppercase">
              Let's build <br /> <span className="text-primary italic">something</span> <br /> together
            </motion.h2>
            <motion.p variants={fadeUp} className="text-white/50 text-lg mb-12 max-w-md">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {contactInfo.map((info, i) => (
                ...
                >
                  <div className="text-primary mb-3 group-hover:scale-110 transition-transform scale-90 origin-left">{info.icon}</div>
          ...
          <motion.div
            variants={fadeUp}
            className="bg-white rounded-[2rem] p-8 md:p-12 text-dark"
          >
            <form className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    className="w-full px-6 py-4 rounded-xl bg-off-white border-2 border-transparent focus:border-primary focus:bg-white transition-all outline-none font-bold"
                  />
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <textarea 
                  ...
                  className="w-full px-6 py-4 rounded-xl bg-off-white border-2 border-transparent focus:border-primary focus:bg-white transition-all outline-none font-bold resize-none"
                ></textarea>
              </div>
              <button className="w-full bg-dark text-white py-5 rounded-xl font-black uppercase tracking-widest hover:bg-primary transition-all flex items-center justify-center gap-3 group">
                Send Message

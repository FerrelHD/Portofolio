...
const SuitSelector = () => {
  ...
  return (
    <div className="fixed bottom-20 left-4 sm:bottom-24 sm:left-6 z-40">
      <div className="relative">
        {/* EXPANDED POPOVER MENU (Tepat di atas tombol) */}
        <AnimatePresence>
          {isOpen && (
            <motion.div
        ...
        {/* SPIDER ICON FLOATING BUTTON (Tepat di atas Audio Player) */}
        <button

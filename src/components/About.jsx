...
const About = ({ onOpenDailyBugle }) => {
  ...
  return (
    <section
      ref={sectionRef}
      id="about"
      className="-mt-5 sm:-mt-7 md:-mt-8 pt-24 sm:pt-32 md:pt-36 pb-10 sm:pb-14 md:pb-16 relative overflow-hidden bg-spider-red text-white [clip-path:polygon(0_2vw,100%_0,100%_calc(100%-2vw),0_100%)]"
    >
